...
export const SkillsSection = () => {
    ...
    const groupedSkills = {
        ...
        "CMS & E-Commerce": [
            ...
            { title: "WordPress", icon: "📝", description: "Weit verbreitetes CMS mit Fokus auf Blogging und einfache Website-Erstellung." },
        ],
        Tools: [
            ...
            { title: "GitHub Actions", icon: "⚙️", description: "Automatisierte Workflows für CI/CD direkt in GitHub integriert." },
        ],
    };
